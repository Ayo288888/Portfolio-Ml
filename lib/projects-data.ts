...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    subtitle: "Multi-modal forensic verification via Wav2Vec2 & YOLO",
    category: "Security",
    tags: ["PyTorch", "Wav2Vec2", "YOLO", "Audio/Vision Forensics"],
    image: "/abstract-neural-network-visualization-dark-theme.jpg",
    year: "2026",
    description:
      "Multi-modal forensic deepfake defense system integrating audio analysis via Wav2Vec2 and visual artifact detection with YOLO & PyTorch to detect manipulated facial & vocal media in real time.",
    architecture: [
    ...
    metrics: "Multi-modal Forensic Verification",
  },
  {
    id: "kitti-detection",
