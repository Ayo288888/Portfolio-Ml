...
export interface LeafNodeConfig {
  ...
  side: "left" | "right";
  /** Relative horizontal percentage offset (0% to 100%) from trunk to node */
  xOffsetPct: number;
...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    year: "2026",
    shortDescription:
      "Interactive RAG-powered research paper reader enabling natural language queries over complex academic literature with precise citation grounding.",
    longDescription:
  ...
  },
  {
    ...
    year: "2025",
    shortDescription:
      "Clinical NLP assistant fine-tuned on MedBERT and ClinicalBERT for rapid medical symptom analysis and triage advice.",
    longDescription:
  ...
  },
  {
    ...
    year: "2026",
    shortDescription:
      "Real-time email and URL phishing detection pipeline combining gradient boosting (XGBoost) and NLP feature engineering.",
    longDescription:
  ...
  },
  {
    ...
    year: "2026",
    shortDescription:
      "Multi-modal deepfake detection platform analyzing spectral audio anomalies (Wav2Vec2) and spatial facial distortions (YOLO/CNN).",
    longDescription:
  ...
  },
  {
    ...
    year: "2026",
    shortDescription:
      "Custom fine-tuned BERT and DistilBERT models for fine-grained aspect-based sentiment classification.",
    longDescription:
